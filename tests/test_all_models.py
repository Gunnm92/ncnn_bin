...
BINARY_PATH = str(REPO_ROOT / "bdreader-ncnn-upscaler" / "build-release" / "bdreader-ncnn-upscaler")
MODELS_BASE = str(REPO_ROOT / "models")
TEST_IMAGES_DIR = str(REPO_ROOT / "img_test")
